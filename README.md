...
```
#### BHMA 4A Εκτέλεση Πειραμάτων με Διαφορετικά Μεγέθη Μνήμης και 1000 Επαναλήψεις
...
#### ΒΗΜΑ 4Β Αποτελέσματα Πειραμάτων XSBench
...
Αυτή η ανάλυση μας βοηθά να κατανοήσουμε πώς ο ανταγωνισμός στους πόρους επηρεάζει την απόδοση των εφαρμογών σε ένα πολυπύρηνο επεξεργαστικό σύστημα και ποιοι παράγοντες πρέπει να λαμβάνονται υπόψη κατά τη συνεκτέλεση εφαρμογών.
